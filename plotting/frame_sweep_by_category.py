# Ported from Wavy-Hec/CVBench bench/frame_sweep_by_category_fig.py @ db18c06
...
Deviation from the fork source: the fork keeps frozen fallback arrays to plot
when the pooled JSONL is missing. Results never live in this repo, so this port
requires --jsonl instead.
