...
from harnesses.clip_select import (FrameSelectMethod, ClipScoreSelectMethod,
                                    clip_scores, option_texts, present_selected,
                                    _clip_meta, FRAME_MARKER)
...
class OptionUnionClipSelect(ClipScoreSelectMethod):
    ...
    def _option_matrix(self, paths, queries):
        ...
        rows = []
        if self.use_viclip:
            from harnesses.viclip_scorer import viclip_option_scores, VICLIP_NFRAMES
